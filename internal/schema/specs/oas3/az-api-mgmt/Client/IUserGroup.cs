...
namespace Apimanagement
{
    ...
    public partial interface IUserGroup
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<GroupCollection>> ListWithHttpMessagesAsync(string resourceGroupName, string serviceName, string userId, string filter = default(string), int? top = default(int?), int? skip = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
