...
namespace Apimanagement
{
    ...
    /// <summary>
    /// Extension methods for TenantConfiguration.
    /// </summary>
    public static partial class TenantConfigurationExtensions
    {
            ...
            /// </param>
            public static OperationResultContract Deploy(this ITenantConfiguration operations, string resourceGroupName, string serviceName, DeployConfigurationParameters parameters)
            {
            ...
            /// </param>
            public static async Task<OperationResultContract> DeployAsync(this ITenantConfiguration operations, string resourceGroupName, string serviceName, DeployConfigurationParameters parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static OperationResultContract Save(this ITenantConfiguration operations, string resourceGroupName, string serviceName, SaveConfigurationParameter parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationResultContract> SaveAsync(this ITenantConfiguration operations, string resourceGroupName, string serviceName, SaveConfigurationParameter parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static OperationResultContract Validate(this ITenantConfiguration operations, string resourceGroupName, string serviceName, DeployConfigurationParameters parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OperationResultContract> ValidateAsync(this ITenantConfiguration operations, string resourceGroupName, string serviceName, DeployConfigurationParameters parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The name of the API Management service.
            /// </param>
            public static TenantConfigurationSyncStateContract GetSyncState(this ITenantConfiguration operations, string resourceGroupName, string serviceName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TenantConfigurationSyncStateContract> GetSyncStateAsync(this ITenantConfiguration operations, string resourceGroupName, string serviceName, CancellationToken cancellationToken = default(CancellationToken))
            {
