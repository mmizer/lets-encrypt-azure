...
namespace Apimanagement
{
    ...
    /// </summary>
    public partial interface IApiExport
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ApiExportResult>> GetWithHttpMessagesAsync(string resourceGroupName, string serviceName, string apiId, string format, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
