...
namespace Apimanagement
{
    ...
    /// </summary>
    public partial interface IApiProduct
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<ProductCollection>> ListByApisWithHttpMessagesAsync(string resourceGroupName, string serviceName, string apiId, string filter = default(string), int? top = default(int?), int? skip = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
