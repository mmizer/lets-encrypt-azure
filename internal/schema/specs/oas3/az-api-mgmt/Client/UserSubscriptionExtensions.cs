...
namespace Apimanagement
{
    ...
    /// </summary>
    public static partial class UserSubscriptionExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static SubscriptionCollection List(this IUserSubscription operations, string resourceGroupName, string serviceName, string userId, string filter = default(string), int? top = default(int?), int? skip = default(int?))
            {
            ...
            /// </param>
            public static async Task<SubscriptionCollection> ListAsync(this IUserSubscription operations, string resourceGroupName, string serviceName, string userId, string filter = default(string), int? top = default(int?), int? skip = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
