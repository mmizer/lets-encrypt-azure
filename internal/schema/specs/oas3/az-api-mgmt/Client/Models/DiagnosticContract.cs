...
namespace Apimanagement.Models
{
    ...
    public partial class DiagnosticContract : Resource
    {
        ...
        /// <param name="backendProperty">Diagnostic settings for
        /// incoming/outgoing HTTP messages to the Backend</param>
        ...
        public DiagnosticContract(string loggerId, string id = default(string), string name = default(string), string type = default(string), string alwaysLog = default(string), SamplingSettings sampling = default(SamplingSettings), PipelineDiagnosticSettings frontend = default(PipelineDiagnosticSettings), PipelineDiagnosticSettings backendProperty = default(PipelineDiagnosticSettings), bool? logClientIp = default(bool?), string httpCorrelationProtocol = default(string), string verbosity = default(string))
            : base(id, name, type)
        {
            AlwaysLog = alwaysLog;
            LoggerId = loggerId;
        ...
        public PipelineDiagnosticSettings BackendProperty { get; set; }
