...
namespace Apimanagement.Models
{
    ...
    public partial class IssueCollection
    {
        ...
        public IssueCollection(IList<IssueContract> value = default(IList<IssueContract>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<IssueContract> Value { get; private set; }
