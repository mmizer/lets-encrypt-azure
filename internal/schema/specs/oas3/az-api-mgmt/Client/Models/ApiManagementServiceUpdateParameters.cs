...
namespace Apimanagement.Models
{
    ...
    public partial class ApiManagementServiceUpdateParameters : ApimResource
    {
        ...
        /// service.&lt;/br&gt;&lt;/br&gt;Not specifying any of these
        /// properties on PATCH operation will reset omitted properties' values
        /// to their defaults. For all the settings except Http2 the default
        /// value is `True` if the service was created on or before April 1st
        /// 2018 and `False` otherwise. Http2 setting's default value is
        /// `False`.&lt;/br&gt;&lt;/br&gt;You can disable any of next ciphers
        /// by using settings
        /// `Microsoft.WindowsAzure.ApiManagement.Gateway.Security.Ciphers.[cipher_name]`:&lt;/br&gt;TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA&lt;/br&gt;TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA&lt;/br&gt;TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA&lt;/br&gt;TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA&lt;/br&gt;TLS_RSA_WITH_AES_128_GCM_SHA256&lt;/br&gt;TLS_RSA_WITH_AES_256_CBC_SHA256&lt;br/&gt;TLS_RSA_WITH_AES_128_CBC_SHA256&lt;br/&gt;TLS_RSA_WITH_AES_256_CBC_SHA&lt;br/&gt;TLS_RSA_WITH_AES_128_CBC_SHA.&lt;br/&gt;&lt;br/&gt;For
        /// example:
        /// `Microsoft.WindowsAzure.ApiManagement.Gateway.Security.Ciphers.TLS_RSA_WITH_AES_128_CBC_SHA256`:`false`.
        /// The default value is `true` for all of
        /// them.&lt;br/&gt;&lt;br/&gt;Note: next ciphers can't be disabled
        /// since they are required by Azure CloudService internal
        /// components:&lt;br/&gt;TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384&lt;br/&gt;TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256&lt;br/&gt;TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384&lt;br/&gt;TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256&lt;br/&gt;TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384&lt;br/&gt;TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256&lt;br/&gt;TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384&lt;br/&gt;TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256&lt;br/&gt;TLS_RSA_WITH_AES_256_GCM_SHA384</param>
        ...
        /// `Microsoft.WindowsAzure.ApiManagement.Gateway.Protocols.Server.Http2`
        /// can be used to enable HTTP2 protocol on an API Management
        /// service.&amp;lt;/br&amp;gt;&amp;lt;/br&amp;gt;Not specifying any of
        /// these properties on PATCH operation will reset omitted properties'
        /// values to their defaults. For all the settings except Http2 the
        /// default value is `True` if the service was created on or before
        /// April 1st 2018 and `False` otherwise. Http2 setting's default value
        /// is `False`.&amp;lt;/br&amp;gt;&amp;lt;/br&amp;gt;You can disable
        /// any of next ciphers by using settings
        /// `Microsoft.WindowsAzure.ApiManagement.Gateway.Security.Ciphers.[cipher_name]`:&amp;lt;/br&amp;gt;TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA&amp;lt;/br&amp;gt;TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA&amp;lt;/br&amp;gt;TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA&amp;lt;/br&amp;gt;TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA&amp;lt;/br&amp;gt;TLS_RSA_WITH_AES_128_GCM_SHA256&amp;lt;/br&amp;gt;TLS_RSA_WITH_AES_256_CBC_SHA256&amp;lt;br/&amp;gt;TLS_RSA_WITH_AES_128_CBC_SHA256&amp;lt;br/&amp;gt;TLS_RSA_WITH_AES_256_CBC_SHA&amp;lt;br/&amp;gt;TLS_RSA_WITH_AES_128_CBC_SHA.&amp;lt;br/&amp;gt;&amp;lt;br/&amp;gt;For
        /// example:
        /// `Microsoft.WindowsAzure.ApiManagement.Gateway.Security.Ciphers.TLS_RSA_WITH_AES_128_CBC_SHA256`:`false`.
        /// The default value is `true` for all of
        /// them.&amp;lt;br/&amp;gt;&amp;lt;br/&amp;gt;Note: next ciphers can't
        /// be disabled since they are required by Azure CloudService internal
        /// components:&amp;lt;br/&amp;gt;TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384&amp;lt;br/&amp;gt;TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256&amp;lt;br/&amp;gt;TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384&amp;lt;br/&amp;gt;TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256&amp;lt;br/&amp;gt;TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384&amp;lt;br/&amp;gt;TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256&amp;lt;br/&amp;gt;TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384&amp;lt;br/&amp;gt;TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256&amp;lt;br/&amp;gt;TLS_RSA_WITH_AES_256_GCM_SHA384
        /// </summary>
