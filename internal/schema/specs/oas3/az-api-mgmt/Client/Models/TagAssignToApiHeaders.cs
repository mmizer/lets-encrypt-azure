...
namespace Apimanagement.Models
{
    ...
    /// </summary>
    public partial class TagAssignToApiHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TagAssignToApiHeaders class.
        /// </summary>
        public TagAssignToApiHeaders()
        {
            CustomInit();
        }
        ...
        public TagAssignToApiHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
