...
namespace Apimanagement.Models
{
    ...
    public partial class SchemaContract : Resource
    {
        ...
        /// Initializes a new instance of the SchemaContract class.
        /// </summary>
        /// <param name="contentTypeProperty">Must be a valid a media type used
        /// in a Content-Type header as defined in the RFC 2616. Media type of
        /// the schema document (e.g. application/json, application/xml).
        ...
        public SchemaContract(string contentTypeProperty, string id = default(string), string name = default(string), string type = default(string), string value = default(string), object definitions = default(object))
            : base(id, name, type)
        {
        ...
        public string ContentTypeProperty { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "ContentTypeProperty");
            }
        }
    }
}
