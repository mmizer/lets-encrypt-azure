...
namespace Apimanagement.Models
{
    ...
    public partial class ApiVersionSetCollection
    {
        ...
        public ApiVersionSetCollection(IList<ApiVersionSetContract> value = default(IList<ApiVersionSetContract>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<ApiVersionSetContract> Value { get; set; }
