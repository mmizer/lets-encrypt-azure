...
namespace Apimanagement.Models
{
    ...
    public partial class DiagnosticCollection
    {
        ...
        public DiagnosticCollection(IList<DiagnosticContract> value = default(IList<DiagnosticContract>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<DiagnosticContract> Value { get; set; }
