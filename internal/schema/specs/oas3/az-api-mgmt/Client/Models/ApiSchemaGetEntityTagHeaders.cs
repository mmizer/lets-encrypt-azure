...
namespace Apimanagement.Models
{
    ...
    /// </summary>
    public partial class ApiSchemaGetEntityTagHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ApiSchemaGetEntityTagHeaders
        /// class.
        /// </summary>
        ...
        public ApiSchemaGetEntityTagHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
