...
namespace Apimanagement.Models
{
    ...
    /// </summary>
    public partial class BackendCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BackendCreateOrUpdateHeaders
        /// class.
        /// </summary>
        ...
        public BackendCreateOrUpdateHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
