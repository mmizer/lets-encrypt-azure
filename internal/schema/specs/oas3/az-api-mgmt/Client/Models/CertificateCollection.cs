...
namespace Apimanagement.Models
{
    ...
    public partial class CertificateCollection
    {
        ...
        public CertificateCollection(IList<CertificateContract> value = default(IList<CertificateContract>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<CertificateContract> Value { get; set; }
