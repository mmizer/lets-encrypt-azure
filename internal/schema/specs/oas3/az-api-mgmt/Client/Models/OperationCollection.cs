...
namespace Apimanagement.Models
{
    ...
    public partial class OperationCollection
    {
        ...
        public OperationCollection(IList<OperationContract> value = default(IList<OperationContract>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<OperationContract> Value { get; private set; }
