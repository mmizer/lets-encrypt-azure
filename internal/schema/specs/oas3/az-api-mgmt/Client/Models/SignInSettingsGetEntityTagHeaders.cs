...
namespace Apimanagement.Models
{
    ...
    /// </summary>
    public partial class SignInSettingsGetEntityTagHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SignInSettingsGetEntityTagHeaders
        /// class.
        /// </summary>
        ...
        public SignInSettingsGetEntityTagHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
