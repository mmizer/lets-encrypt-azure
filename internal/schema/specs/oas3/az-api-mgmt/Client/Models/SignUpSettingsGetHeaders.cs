...
namespace Apimanagement.Models
{
    ...
    /// </summary>
    public partial class SignUpSettingsGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SignUpSettingsGetHeaders class.
        /// </summary>
        public SignUpSettingsGetHeaders()
        {
            CustomInit();
        }
        ...
        public SignUpSettingsGetHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
