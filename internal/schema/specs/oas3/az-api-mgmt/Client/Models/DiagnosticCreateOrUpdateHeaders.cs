...
namespace Apimanagement.Models
{
    ...
    /// </summary>
    public partial class DiagnosticCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DiagnosticCreateOrUpdateHeaders
        /// class.
        /// </summary>
        ...
        public DiagnosticCreateOrUpdateHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
