...
namespace Apimanagement.Models
{
    ...
    /// </summary>
    public partial class CertificateCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CertificateCreateOrUpdateHeaders
        /// class.
        /// </summary>
        public CertificateCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        public CertificateCreateOrUpdateHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
