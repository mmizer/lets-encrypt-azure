...
namespace Apimanagement.Models
{
    ...
    /// </summary>
    public partial class GatewayApiGetEntityTagHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GatewayApiGetEntityTagHeaders
        /// class.
        /// </summary>
        ...
        public GatewayApiGetEntityTagHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
